...
namespace Pathfinding.Legacy
{
	...
	{
		// Token: 0x06000898 RID: 2200 RVA: 0x000422A0 File Offset: 0x000406A0
		...
		// Token: 0x06000899 RID: 2201 RVA: 0x000422F8 File Offset: 0x000406F8
		...
		// Token: 0x0600089A RID: 2202 RVA: 0x000423F4 File Offset: 0x000407F4
		...
		// Token: 0x0600089B RID: 2203 RVA: 0x000424A4 File Offset: 0x000408A4
		...
		// Token: 0x0600089C RID: 2204 RVA: 0x000424D8 File Offset: 0x000408D8
		protected new Vector3 CalculateVelocity(Vector3 currentPosition)
		{
			...
			while (this.currentWaypointIndex < vectorPath.Count - 1)
			{
				...
				else
				{
					...
					float num3 = this.maxSpeed * Mathf.Max(a2, this.minMoveScale) * num2;
		...
		// Token: 0x0600089D RID: 2205 RVA: 0x00042700 File Offset: 0x00040B00
		...
		// Token: 0x0600089E RID: 2206 RVA: 0x00042778 File Offset: 0x00040B78
